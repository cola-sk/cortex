...
**审查网关** — 人工介入的质量检查点：审查者智能体输出分析结果后，由操作员决定通过（Approve & Continue）或打回修改（Request Revision）

<p align="center">
  <img src="public/screenshot-review.png" alt="审查网关界面：通过/打回操作" width="780">
</p>

**执行记录** — 浏览历史执行记录，按状态筛选，查看每个任务的详细输出和完整的工具调用时间线

<p align="center">
  <img src="public/screenshot-runs.png" alt="执行记录页面：历史列表与任务详情面板" width="780">
</p>
